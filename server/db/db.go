...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.setTodoStmt, err = db.PrepareContext(ctx, setTodo); err != nil {
		return nil, fmt.Errorf("error preparing query SetTodo: %w", err)
	}
	return &q, nil
}
...
func (q *Queries) Close() error {
	...
	if q.setTodoStmt != nil {
		if cerr := q.setTodoStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing setTodoStmt: %w", cerr)
		}
	}
	return err
}
